...
<a href="https://github.com/clouddrove/terraform-gcp-dns/releases/latest">
  <img src="https://img.shields.io/github/release/clouddrove/terraform-gcp-dns.svg" alt="Latest Release">
</a>
<a href="https://github.com/clouddrove/terraform-gcp-dns/actions/workflows/tfsec.yml">
  <img src="https://github.com/clouddrove/terraform-gcp-dns/actions/workflows/tfsec.yml/badge.svg" alt="tfsec">
</a>
<a href="LICENSE.md">
...
<a href='https://facebook.com/sharer/sharer.php?u=https://github.com/clouddrove/terraform-gcp-dns'>
...
<a href='https://www.linkedin.com/shareArticle?mini=true&title=Terraform+GCP+DNS&url=https://github.com/clouddrove/terraform-gcp-dns'>
  <img title="Share on LinkedIn" src="https://user-images.githubusercontent.com/50652676/62817742-4e339e80-bb59-11e9-87b9-a1f68cae1049.png" />
</a>
<a href='https://twitter.com/intent/tweet/?text=Terraform+GCP+DNS&url=https://github.com/clouddrove/terraform-gcp-dns'>
...
|:-------------:|:-------------------------------------------:|:---------:|
| **Prerequisite** | [Terraform](https://learn.hashicorp.com/terraform/getting-started/install.html) | >= 0.13 |
| **Provider** | [gcp](https://cloud.google.com/) | >= 4.40, < 6 |
...
**IMPORTANT:** Since the master branch used in source varies based on new modifications, we recommend using the [release versions](https://github.com/clouddrove/terraform-gcp-dns/releases).
...
<a href="https://github.com/clouddrove/terraform-gcp-dns/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=clouddrove/terraform-gcp-dns&max" />
</a>
<br>
<br>
...
## Feedback 
Spot a bug or have thoughts to share with us? Let's squash it together! Log it in our [issue tracker](https://github.com/clouddrove/terraform-gcp-dns/issues), feel free to drop us an email at [hello@clouddrove.com](mailto:hello@clouddrove.com).

Show some love with a ★ on [our GitHub](https://github.com/clouddrove/terraform-gcp-dns)!  if our work has brightened your day! – your feedback fuels our journey!
